---
title: "OSF Pre-Analyis-Plan Template"
  ...
  nature-pdf:
    ...
    include-in-header:
      text: |
        ...
        \usepackage{setspace}
        \usepackage{etoolbox}
        % Set body text to 12pt (overrides sn-jnl.cls hardcoded 10pt normalsize)
        \makeatletter
        \renewcommand\normalsize{%
        ...
        \makeatother
        \normalsize
        % Double spacing for all body text
        \setstretch{2}
...
Enter your response here. Cite like this [@einstein1905]
